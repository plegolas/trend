...
void approach_3::build_sets( signalSource source, vector<signal> *rplus, vector<signal> *rminus, vector<signal> *rzero ){
...
int approach_3::positive_trade( vector<float> source, vector<int> decision, int i, int order_side ){
...
vector<int> approach_3::decision_ma( vector<float> vsource, int period1, int period2 ){
	int i = 0;
